function [parameter_iteration, out] = PEM_SMC_AFP(Np, S, bound, logpdf_handle, options)
%PEM_SMC_AFP  Tempered SMC with (i) a robust rCESS-band adaptive schedule
...
%   [parameter_iteration, out] = PEM_SMC_AFP(Np, S, bound)
%   [parameter_iteration, out] = PEM_SMC_AFP(Np, S, bound, @logpdf, options)
%
% Inputs
...
if hit_budget && (beta_last < 1 - 1e-12)
    error('PEM_SMC_AFP:MaxStagesTooSmall', ...
