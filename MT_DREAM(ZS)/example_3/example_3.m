...
sigma_LE=importdata('sigma_LE.txt');
sigma_NEE=importdata('sigma_NEE.txt');
sigma_RSM=importdata('sigma_RSM.txt');
plugin.sigma_LE=sigma_LE;
plugin.sigma_NEE=sigma_NEE;
plugin.sigma_RSM=sigma_RSM;
